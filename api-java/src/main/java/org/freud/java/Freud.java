...
//        return curriedAssertion.call();
    ...
    public static FreudSource<File> filesIn(String... paths) {
        return new FreudSource<File>(new FileIterator(asList(paths), true, null), File.class);
    }

    public static FreudSource<File> nonRecursivelyFilesIn(String... paths) {
        return new FreudSource<File>(new FileIterator(asList(paths), false, null), File.class);
    }

    public static FreudSource<File> filesIn(FilenameFilter filter, String... paths) {
        return new FreudSource<File>(new FileIterator(asList(paths), true, filter), File.class);
    }

    public static FreudSource<File> nonRecursivelyFilesIn(FilenameFilter filter, String... paths) {
        return new FreudSource<File>(new FileIterator(asList(paths), false, filter), File.class);
    }

    public static FreudSource<File> filesIn(File... files) {
        return new FreudSource<File>(new FileIterator(asList(files), true, null), File.class);
    }

    public static FreudSource<File> nonRecursivelyFilesIn(File... files) {
        return new FreudSource<File>(new FileIterator(asList(files), false, null), File.class);
    }

    public static FreudSource<File> filesIn(FilenameFilter filter, File... files) {
        return new FreudSource<File>(new FileIterator(asList(files), true, filter), File.class);
    }

    public static FreudSource<File> nonRecursivelyFilesIn(FilenameFilter filter, File... files) {
        return new FreudSource<File>(new FileIterator(asList(files), false, filter), File.class);
    }
