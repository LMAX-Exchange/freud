...
public enum Opcode
{
    NOP
            {
                public OperandStack updateOperandStack(final ClassByteCodeMethod method, final Instruction instruction, OperandStack stack)
                {
                    return stack;
                }
    ...
    public abstract OperandStack updateOperandStack(final ClassByteCodeMethod method, final Instruction instruction, OperandStack stack);
