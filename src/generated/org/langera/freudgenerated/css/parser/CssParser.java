// $ANTLR 3.2 Sep 23, 2009 12:02:23 C:\\dev\\freud\\src\\grammar\\Css.g 2010-07-22 22:27:54
...
public class CssParser extends Parser {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:40:1: stylesheet : ( importRule )* ( nested | ruleset )+ ;
    public final CssParser.stylesheet_return stylesheet() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:41:2: ( ( importRule )* ( nested | ruleset )+ )
            // C:\\dev\\freud\\src\\grammar\\Css.g:41:4: ( importRule )* ( nested | ruleset )+
            {
            root_0 = (CommonTree)adaptor.nil();

            // C:\\dev\\freud\\src\\grammar\\Css.g:41:4: ( importRule )*
            loop1:
            do {
                int alt1=2;
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:41:16: ( nested | ruleset )+
            int cnt2=0;
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:41:17: nested
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:41:26: ruleset
            	    {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:44:1: importRule : ( '@import' | '@include' ) IDENT -> ^( IMPORT IDENT ) ;
    public final CssParser.importRule_return importRule() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:45:2: ( ( '@import' | '@include' ) IDENT -> ^( IMPORT IDENT ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:45:4: ( '@import' | '@include' ) IDENT
            {
            // C:\\dev\\freud\\src\\grammar\\Css.g:45:4: ( '@import' | '@include' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:45:5: '@import'
                    {
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:45:17: '@include'
                    {
            ...
            // 45:36: -> ^( IMPORT IDENT )
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:45:39: ^( IMPORT IDENT )
                {
    ...
    // $ANTLR start "nested"
    // C:\\dev\\freud\\src\\grammar\\Css.g:48:1: nested : '@' nest '{' ( properties )? ( nested )* '}' -> ^( NESTED nest ( properties )* ( nested )* ) ;
    public final CssParser.nested_return nested() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:49:3: ( '@' nest '{' ( properties )? ( nested )* '}' -> ^( NESTED nest ( properties )* ( nested )* ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:49:5: '@' nest '{' ( properties )? ( nested )* '}'
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:49:18: ( properties )?
            int alt4=2;
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:49:30: ( nested )*
            loop5:
            do {
                int alt5=2;
            ...
            // AST REWRITE
            // elements: properties, nested, nest
            // token labels:
            // rule labels: retval
            // token list labels:
            // rule list labels:
            ...
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:49:45: ^( NESTED nest ( properties )* ( nested )* )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "nest"
    // C:\\dev\\freud\\src\\grammar\\Css.g:52:1: nest : IDENT ( IDENT )* ( pseudo )* -> ^( NEST IDENT ( IDENT )* ( pseudo )* ) ;
    public final CssParser.nest_return nest() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:53:2: ( IDENT ( IDENT )* ( pseudo )* -> ^( NEST IDENT ( IDENT )* ( pseudo )* ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:53:4: IDENT ( IDENT )* ( pseudo )*
            {
            IDENT13=(Token)match(input,IDENT,FOLLOW_IDENT_in_nest222);
            stream_IDENT.add(IDENT13);

            // C:\\dev\\freud\\src\\grammar\\Css.g:53:10: ( IDENT )*
            loop6:
            do {
                int alt6=2;
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:53:17: ( pseudo )*
            loop7:
            do {
                int alt7=2;
            ...
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:53:28: ^( NEST IDENT ( IDENT )* ( pseudo )* )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(NEST, "NEST"), root_1);

                adaptor.addChild(root_1, stream_IDENT.nextNode());
                // C:\\dev\\freud\\src\\grammar\\Css.g:53:42: ( IDENT )*
                while ( stream_IDENT.hasNext() ) {
                    adaptor.addChild(root_1, stream_IDENT.nextNode());

                }
                stream_IDENT.reset();
                // C:\\dev\\freud\\src\\grammar\\Css.g:53:49: ( pseudo )*
    ...
    // $ANTLR start "ruleset"
    // C:\\dev\\freud\\src\\grammar\\Css.g:56:1: ruleset : selectors '{' ( properties )? '}' -> ^( RULE selectors ( properties )* ) ;
    public final CssParser.ruleset_return ruleset() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_properties=new RewriteRuleSubtreeStream(adaptor,"rule properties");
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:57:3: ( selectors '{' ( properties )? '}' -> ^( RULE selectors ( properties )* ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:57:5: selectors '{' ( properties )? '}'
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:57:19: ( properties )?
            int alt8=2;
            ...
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:57:38: ^( RULE selectors ( properties )* )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(RULE, "RULE"), root_1);

                adaptor.addChild(root_1, stream_selectors.nextTree());
                // C:\\dev\\freud\\src\\grammar\\Css.g:57:56: ( properties )*
                while ( stream_properties.hasNext() ) {
                    adaptor.addChild(root_1, stream_properties.nextTree());
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:60:1: selectors : selector ( ',' selector )* ;
    public final CssParser.selectors_return selectors() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:61:2: ( selector ( ',' selector )* )
            // C:\\dev\\freud\\src\\grammar\\Css.g:61:4: selector ( ',' selector )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:61:13: ( ',' selector )*
            loop9:
            do {
                int alt9=2;
                ...
                switch (alt9) {
            	case 1 :
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:61:14: ',' selector
            	    {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:64:1: selector : elem ( selectorOperation )* ( attrib )* ( pseudo )? -> elem ( selectorOperation )* ( attrib )* ( pseudo )* ;
    public final CssParser.selector_return selector() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:65:2: ( elem ( selectorOperation )* ( attrib )* ( pseudo )? -> elem ( selectorOperation )* ( attrib )* ( pseudo )* )
            // C:\\dev\\freud\\src\\grammar\\Css.g:65:4: elem ( selectorOperation )* ( attrib )* ( pseudo )?
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:65:9: ( selectorOperation )*
            loop10:
            do {
                int alt10=2;
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:65:28: ( attrib )*
            loop11:
            do {
                int alt11=2;
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:65:36: ( pseudo )?
            int alt12=2;
            ...
            // AST REWRITE
            // elements: attrib, pseudo, selectorOperation, elem
            // token labels:
            // rule labels: retval
            // token list labels:
            // rule list labels:
            ...
            // 65:44: -> elem ( selectorOperation )* ( attrib )* ( pseudo )*
            {
                ...
                // C:\\dev\\freud\\src\\grammar\\Css.g:65:53: ( selectorOperation )*
                ...
                // C:\\dev\\freud\\src\\grammar\\Css.g:65:72: ( attrib )*
                while ( stream_attrib.hasNext() ) {
                    adaptor.addChild(root_0, stream_attrib.nextTree());

                }
                stream_attrib.reset();
                // C:\\dev\\freud\\src\\grammar\\Css.g:65:80: ( pseudo )*
                while ( stream_pseudo.hasNext() ) {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:68:1: selectorOperation : ( selectop )? elem -> ( selectop )* elem ;
    public final CssParser.selectorOperation_return selectorOperation() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:69:2: ( ( selectop )? elem -> ( selectop )* elem )
            // C:\\dev\\freud\\src\\grammar\\Css.g:69:4: ( selectop )? elem
            {
            // C:\\dev\\freud\\src\\grammar\\Css.g:69:4: ( selectop )?
            int alt13=2;
            ...
            // 69:19: -> ( selectop )* elem
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:69:22: ( selectop )*
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:72:1: selectop : ( '>' -> CHILD | '+' -> ADJACENT_SIBLING );
    public final CssParser.selectop_return selectop() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:73:2: ( '>' -> CHILD | '+' -> ADJACENT_SIBLING )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:73:4: '>'
                    {
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:74:11: '+'
                    {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:77:1: properties : declaration ( ';' ( declaration )? )* -> ( declaration )+ ;
    public final CssParser.properties_return properties() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:78:2: ( declaration ( ';' ( declaration )? )* -> ( declaration )+ )
            // C:\\dev\\freud\\src\\grammar\\Css.g:78:4: declaration ( ';' ( declaration )? )*
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:78:16: ( ';' ( declaration )? )*
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:78:17: ';' ( declaration )?
            	    {
            	    char_literal32=(Token)match(input,34,FOLLOW_34_in_properties398);
            	    stream_34.add(char_literal32);

            	    // C:\\dev\\freud\\src\\grammar\\Css.g:78:21: ( declaration )?
            	    int alt15=2;
    ...
    // $ANTLR start "elem"
    // C:\\dev\\freud\\src\\grammar\\Css.g:81:1: elem : ( '*' -> ^( UNIVERSAL ) | '#' IDENT -> ^( ID IDENT ) | '.' IDENT -> ^( CLASS IDENT ) | IDENT -> ^( TAG IDENT ) );
    public final CssParser.elem_return elem() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:82:2: ( '*' -> ^( UNIVERSAL ) | '#' IDENT -> ^( ID IDENT ) | '.' IDENT -> ^( CLASS IDENT ) | IDENT -> ^( TAG IDENT ) )
            int alt17=4;
            switch ( input.LA(1) ) {
            case 35:
                {
            ...
            switch (alt17) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:82:4: '*'
                    {
                    ...
                    // 82:8: -> ^( UNIVERSAL )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:82:11: ^( UNIVERSAL )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:83:4: '#' IDENT
                    {
                    ...
                    // 83:14: -> ^( ID IDENT )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:83:17: ^( ID IDENT )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:84:4: '.' IDENT
                    {
                    ...
                    // 84:14: -> ^( CLASS IDENT )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:84:17: ^( CLASS IDENT )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:85:4: IDENT
                    {
                    ...
                    // 85:10: -> ^( TAG IDENT )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:85:13: ^( TAG IDENT )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "pseudo"
    // C:\\dev\\freud\\src\\grammar\\Css.g:88:1: pseudo : ( ( ':' | '::' ) IDENT -> ^( PSEUDO IDENT ) | ( ':' | '::' ) function -> ^( PSEUDO function ) );
    public final CssParser.pseudo_return pseudo() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:89:2: ( ( ':' | '::' ) IDENT -> ^( PSEUDO IDENT ) | ( ':' | '::' ) function -> ^( PSEUDO function ) )
            int alt20=2;
            alt20 = dfa20.predict(input);
            switch (alt20) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:89:4: ( ':' | '::' ) IDENT
                    {
                    // C:\\dev\\freud\\src\\grammar\\Css.g:89:4: ( ':' | '::' )
                    int alt18=2;
                    ...
                    switch (alt18) {
                        case 1 :
                            // C:\\dev\\freud\\src\\grammar\\Css.g:89:5: ':'
                            {
                            ...
                            break;
                        case 2 :
                            // C:\\dev\\freud\\src\\grammar\\Css.g:89:9: '::'
                            {
                    ...
                    // 89:21: -> ^( PSEUDO IDENT )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:89:24: ^( PSEUDO IDENT )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:90:4: ( ':' | '::' ) function
                    {
                    // C:\\dev\\freud\\src\\grammar\\Css.g:90:4: ( ':' | '::' )
                    int alt19=2;
                    ...
                    switch (alt19) {
                        case 1 :
                            // C:\\dev\\freud\\src\\grammar\\Css.g:90:5: ':'
                            {
                            ...
                            break;
                        case 2 :
                            // C:\\dev\\freud\\src\\grammar\\Css.g:90:9: '::'
                            {
                    ...
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:90:27: ^( PSEUDO function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(PSEUDO, "PSEUDO"), root_1);
    ...
    // $ANTLR start "attrib"
    // C:\\dev\\freud\\src\\grammar\\Css.g:93:1: attrib : '[' IDENT ( attribRelate IDENT )? ']' -> ^( ATTRIB IDENT ( attribRelate ( IDENT )* )? ) ;
    public final CssParser.attrib_return attrib() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:94:2: ( '[' IDENT ( attribRelate IDENT )? ']' -> ^( ATTRIB IDENT ( attribRelate ( IDENT )* )? ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:94:4: '[' IDENT ( attribRelate IDENT )? ']'
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:94:14: ( attribRelate IDENT )?
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:94:15: attribRelate IDENT
                    {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:97:1: attribRelate : ( '=' -> ATTRIBEQUAL | '~=' -> HASVALUE | '|=' -> BEGINSWITH );
    public final CssParser.attribRelate_return attribRelate() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:98:2: ( '=' -> ATTRIBEQUAL | '~=' -> HASVALUE | '|=' -> BEGINSWITH )
            int alt22=3;
            switch ( input.LA(1) ) {
            case 42:
                {
            ...
            switch (alt22) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:98:4: '='
                    {
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:99:4: '~='
                    {
                    ...
                    break;
                case 3 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:100:4: '|='
                    {
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:103:1: declaration : IDENT ':' args -> ^( PROPERTY IDENT args ) ;
    public final CssParser.declaration_return declaration() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:104:2: ( IDENT ':' args -> ^( PROPERTY IDENT args ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:104:4: IDENT ':' args
            {
            ...
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:104:22: ^( PROPERTY IDENT args )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "args"
    // C:\\dev\\freud\\src\\grammar\\Css.g:107:1: args : expr ( ( ',' )? expr )* -> ( expr )* ;
    public final CssParser.args_return args() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:108:2: ( expr ( ( ',' )? expr )* -> ( expr )* )
            // C:\\dev\\freud\\src\\grammar\\Css.g:108:4: expr ( ( ',' )? expr )*
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:108:9: ( ( ',' )? expr )*
            loop24:
            do {
                int alt24=2;
                ...
                switch (alt24) {
            	case 1 :
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:108:10: ( ',' )? expr
            	    {
            	    // C:\\dev\\freud\\src\\grammar\\Css.g:108:10: ( ',' )?
            	    int alt23=2;
            ...
            // 108:22: -> ( expr )*
            {
                // C:\\dev\\freud\\src\\grammar\\Css.g:108:25: ( expr )*
    ...
    // $ANTLR start "expr"
    // C:\\dev\\freud\\src\\grammar\\Css.g:111:1: expr : ( ( IDENT unit ) | IDENT | '#' IDENT -> ^( COLOUR '#' IDENT ) | '.' IDENT | function );
    public final CssParser.expr_return expr() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:112:2: ( ( IDENT unit ) | IDENT | '#' IDENT -> ^( COLOUR '#' IDENT ) | '.' IDENT | function )
            int alt25=5;
            alt25 = dfa25.predict(input);
            switch (alt25) {
                case 1 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:112:4: ( IDENT unit )
                    {
                    root_0 = (CommonTree)adaptor.nil();

                    // C:\\dev\\freud\\src\\grammar\\Css.g:112:4: ( IDENT unit )
                    // C:\\dev\\freud\\src\\grammar\\Css.g:112:5: IDENT unit
                    {
                    ...
                    break;
                case 2 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:113:4: IDENT
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:114:4: '#' IDENT
                    {
                    ...
                    // 114:14: -> ^( COLOUR '#' IDENT )
                    {
                        // C:\\dev\\freud\\src\\grammar\\Css.g:114:17: ^( COLOUR '#' IDENT )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:115:4: '.' IDENT
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // C:\\dev\\freud\\src\\grammar\\Css.g:116:4: function
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "unit"
    // C:\\dev\\freud\\src\\grammar\\Css.g:119:1: unit : ( '%' | 'px' | 'cm' | 'mm' | 'in' | 'pt' | 'pc' | 'em' | 'ex' | 'deg' | 'rad' | 'grad' | 'ms' | 's' | 'hz' | 'khz' ) ;
    public final CssParser.unit_return unit() throws RecognitionException {
        ...
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:120:2: ( ( '%' | 'px' | 'cm' | 'mm' | 'in' | 'pt' | 'pc' | 'em' | 'ex' | 'deg' | 'rad' | 'grad' | 'ms' | 's' | 'hz' | 'khz' ) )
            // C:\\dev\\freud\\src\\grammar\\Css.g:120:4: ( '%' | 'px' | 'cm' | 'mm' | 'in' | 'pt' | 'pc' | 'em' | 'ex' | 'deg' | 'rad' | 'grad' | 'ms' | 's' | 'hz' | 'khz' )
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // C:\\dev\\freud\\src\\grammar\\Css.g:123:1: function : IDENT '(' ( args )? ')' -> IDENT '(' ( args )* ')' ;
    public final CssParser.function_return function() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_args=new RewriteRuleSubtreeStream(adaptor,"rule args");
        try {
            // C:\\dev\\freud\\src\\grammar\\Css.g:124:2: ( IDENT '(' ( args )? ')' -> IDENT '(' ( args )* ')' )
            // C:\\dev\\freud\\src\\grammar\\Css.g:124:4: IDENT '(' ( args )? ')'
            {
            ...
            // C:\\dev\\freud\\src\\grammar\\Css.g:124:14: ( args )?
            int alt26=2;
            ...
            // 124:24: -> IDENT '(' ( args )* ')'
            {
                ...
                // C:\\dev\\freud\\src\\grammar\\Css.g:124:37: ( args )*
