...
public final class NestedTypeFilterAnalysisAssertion<Type, NestedType> implements AnalysisAssertion<Type>
{
    private final AnalysisAssertion<NestedType> assertion;
    ...
    public NestedTypeFilterAnalysisAssertion(final NestedTypeAnalysisAdapter<Type, NestedType> nestedTypeAnalysisAssertionAdapter,
                                             final AnalysisAssertion<NestedType> assertion
    )
    {
