...
public final class PackagePathMatchAssertionAdapter implements RegexMatchAnalysisAssertionAdapter<PackageDeclaration>
{
    ...
    public String getStringToMatch(PackageDeclaration toBeAnalysed)
    {
