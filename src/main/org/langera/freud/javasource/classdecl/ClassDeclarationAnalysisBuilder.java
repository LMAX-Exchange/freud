...
import org.langera.freud.javasource.classdecl.assertion.ClassDeclarationNameMatchAssertionAdapter;
        ...
        implements ClassDeclarationDsl
{
    ...
    {
        setRegexAssertionAdapterClass(ClassDeclarationNameMatchAssertionAdapter.class);
        return (CommonDsl<ClassDeclarationAnalysisBuilder, ClassDeclaration>) trueAssertion();
    }
