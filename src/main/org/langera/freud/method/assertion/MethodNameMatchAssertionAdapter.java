...
public final class MethodNameMatchAssertionAdapter implements RegexMatchAnalysisAssertionAdapter<Method>
{
    ...
    public String getStringToMatch(Method toBeAnalysed)
    {
