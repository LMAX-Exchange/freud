...
{
    private Matcher<CssDeclaration> assertion;

    @Test
    public void shouldMatchDeclarationValue()
    {
        Assert.assertTrue(assertion.matches(new SimpleCssDeclaration("color", "#ff0000")));
    }

    @Test
    public void shouldNotMatchDeclarationValue()
    {
        Assert.assertFalse(assertion.matches(new SimpleCssDeclaration("color", "red")));
    }
