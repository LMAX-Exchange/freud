...
public class JavaSourceJdomTest
{
    ...
    @Test
    public void testShouldCreateJavaSourceJdom() throws Exception
    {
    ...
    @Test
    public void testShouldReturnFullClassName() throws Exception
    {
        JavaSourceJdom javaSourceJdom = new JavaSourceJdom(new StringReader(CLASS_EXAMPLE), "Name");
    ...
    @Test
    public void testShouldReturnClassNameWhenNoPackageExists() throws Exception
    {
    ...
    @Test
    public void testShouldParseJavaSource() throws Exception
    {
